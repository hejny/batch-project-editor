...
export const WORKFLOWS: IWorkflow[] = [
    ...
    createUpdateDependencyWorkflow('ptbk'),
    createUpdateDependencyWorkflow('promptbook'),
    ...
    createUpdateDependencyWorkflow('@promptbook/anthropic-claude'),
    createUpdateDependencyWorkflow('@promptbook/azure-openai'),
    ...
    createUpdateDependencyWorkflow('@promptbook/fake-llm'),
    createUpdateDependencyWorkflow('@promptbook/cli'),
    auditDependencies,
    libraryBoilerplate,
    license,
    funding,
