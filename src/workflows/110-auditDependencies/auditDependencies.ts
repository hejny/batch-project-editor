...
export async function auditDependencies({
    ...
    await execCommand({ cwd: projectPath, crashOnError: false, command: 'pnpm install --yes' });
    await execCommand({ cwd: projectPath, crashOnError: false, command: 'pnpm audit fix --yes' });
