...
export const PROJECT_FLAGS: Record<string, { isPrivate: boolean; isArchived: boolean; isFork: boolean }> = {/* Note: It will be filled dynamically with isPrivate:boolean */};
